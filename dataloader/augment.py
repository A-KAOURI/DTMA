...
class Augmentor:
    ...
    def spatial_transform(self, voxel1, voxel2, flow, valid, img1, img2, depth):
        ...
        return voxel1, voxel2, flow, valid, img1, img2, depth

    def __call__(self, voxel1, voxel2, flow, valid, img1, img2, depth):
        voxel1, voxel2, flow, valid, img1, img2, depth = self.spatial_transform(voxel1, voxel2, flow, valid, img1, img2, depth)
